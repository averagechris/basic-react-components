...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    // should "control"
    _this.formComponentTypes = [_formInput2.default].concat(props.componentTypesToRegister);
    return _this;
  }
...
Form.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  componentTypesToRegister: _propTypes2.default.arrayOf(_propTypes2.default.oneOfType([_propTypes2.default.element, _propTypes2.default.func]))
} : {};
