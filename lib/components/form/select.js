  ...
  Select.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        "select",
        {
          className: (0, _helpers.concatClassNames)(selectClasses, addSelectClasses),
          ref: function ref(s) {
        ...
        options.map(function (o, i) {
          return _react2.default.createElement(
            "option",
            {
              className: (0, _helpers.concatClassNames)(optionClasses, addOptionClasses),
...
Select.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  addOptionClasses: _propTypes2.default.arrayOf(_propTypes2.default.string),
  addSelectClasses: _propTypes2.default.arrayOf(_propTypes2.default.string),
