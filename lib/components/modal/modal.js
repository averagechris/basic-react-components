...
var _closeIcon = require("../icons/closeIcon.js");
  ...
  Modal.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      "div",
      {
        ...
        tabIndex: "0",
        className: (0, _helpers.concatClassNames)(dimmerClasses, addDimmerClasses, dimmerColorClass),
      ...
      _react2.default.createElement(
        "div",
        {
          className: (0, _helpers.concatClassNames)(bodyClasses, addBodyClasses, bodyColorClass)
        },
        _react2.default.createElement(
          "div",
          { className: "w1" },
...
Modal.propTypes = process.env.NODE_ENV !== "production" ? {
  addBodyClasses: _propTypes2.default.arrayOf(_propTypes2.default.string),
  addDimmerClasses: _propTypes2.default.arrayOf(_propTypes2.default.string),
  bodyClasses: _propTypes2.default.arrayOf(_propTypes2.default.string),
  bodyColorClass: _propTypes2.default.string,
